...
- The screenshot file input event saves a BMP under the configured Screenshots directory. Clipboard screenshots, PNG/palette options, autoclip, and continuous screenshots are still pending Unix parity work.
