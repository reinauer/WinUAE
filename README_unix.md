...
- The screenshot file input event and integrated runtime Qt Output-page button save a BMP under the configured Screenshots directory. The standalone Qt launcher keeps this runtime-only button disabled. Clipboard screenshots, PNG/palette options, autoclip, and continuous screenshots are still pending Unix parity work.
