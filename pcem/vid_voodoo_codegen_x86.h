...
#define offsetof_array(type, field, index)                      \
        (offsetof(type, field[0]) +                             \
        ((index) * sizeof(((type *)0)->field[0])))

#define offsetof_array_member(type, field, index, member)       \
...
static inline int codegen_texture_fetch(uint8_t *code_block, voodoo_t *voodoo, voodoo_params_t *params, voodoo_state_t *state, int block_pos, int tmu)
{
        if (params->textureMode[tmu] & 1)
        {
                ...
                addbyte(0x87);
                addlong(offsetof_array_member(voodoo_state_t, tmu, tmu, lod));
                addbyte(0x3b); /*CMP EAX, state->lod_min*/
                addbyte(0x87);
                addlong(offsetof_array(voodoo_state_t, lod_min, tmu));
                ...
                addbyte(0x87);
                addlong(offsetof_array(voodoo_state_t, lod_max, tmu));
                ...
                addbyte(0x9f);
                addlong(offsetof_array(voodoo_state_t, lod_frac, tmu));
        ...
        if (params->fbzColorPath & FBZCP_TEXTURE_ENABLED)
        {
                if (voodoo->bilinear_enabled && (params->textureMode[tmu] & 6))
                {
                        ...
                        addbyte(0x8f);
                        addlong(offsetof_array(voodoo_state_t, tex_lod, tmu));
                        ...
                        addbyte(0xac);
                        addbyte(0x8f);
                        addlong(offsetof_array(voodoo_state_t, tex, tmu));
                        ...
                        if (!state->clamp_s[tmu])
                        {
                                ...
                                addbyte(0x86);
                                addlong(offsetof_array(voodoo_params_t, tex_w_mask, tmu));
                        }
                        ...
                        if (state->clamp_t[tmu])
                        {
                                ...
                                addbyte(0x96);
                                addlong(offsetof_array(voodoo_params_t, tex_h_mask, tmu));
                ...
                else
                {
                        ...
                        if (state->clamp_s[tmu])
                        {
                                ...
                                addbyte(0x84);
                                addbyte(0x8e);
                                addlong(offsetof_array(voodoo_params_t, tex_w_mask, tmu) - 0x10);
                        ...
                        if (state->clamp_t[tmu])
                        {
                                ...
                                addbyte(0x9c);
                                addbyte(0x8e);
                                addlong(offsetof_array(voodoo_params_t, tex_h_mask, tmu) - 0x10);
